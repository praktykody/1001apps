...
//funkcja pobierająca argument index i podmieniająca nazwę, src i alt w html
function getSingleView(index) {
  //pobieramy tag h2 z dokumentu HTML'a (DOM- document object mmodel)
...
let currentSlide = 0;
// wywoładnie funkcji z argumentem index równym currentSlide
